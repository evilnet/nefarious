...
/* 009 */
  { 0 },
/* 010 */
  { RPL_BOUNCE, "%s %s :Please use this Server/Port instead", "010" },
/* 011 */
  { 0 },
/* 012 */
  { 0 },
...
/* 225 */
  { 0 },
/* 226 */
  { RPL_STATSbLINE, "b %c %s", "226" },
/* 227 */
  { RPL_STATSRLINE, "R %s %s [%s]", "227" },
/* 228 */
...
/* 239 */
  { RPL_STATSFILTERLINE, "f %s %s %s %d %s :%s", "239" },
/* 240 */
...
/* 279 */
  { 0 },
/* 280 */
  { RPL_GLIST, "%s%s%s %Tu %Tu %s %c :%s", "280" },
/* 281 */
  { RPL_ENDOFGLIST, ":End of G-line List", "281" },
/* 282 */
  { RPL_JUPELIST, "%s %Tu %Tu %s %c :%s", "282" },
/* 283 */
...
/* 339 */
  { RPL_WHOISDNSBL, "%s :is DNSBL/Kill listed on %s%s%s", "339" },
/* 340 */
  { RPL_USERIP, ":", "340" },
/* 341 */
...
/* 490 */
  { ERR_LINKSET, "%s :[Link] %s has has a channel link enabled, so you are automatically being transferred to the linked channel %s", "490" },
/* 491 */
...
/* 544 */
  { RPL_SLIST, "%s%s%s %Tu %Tu %s %c :%s", "544" },
/* 545 */
