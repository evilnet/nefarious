...
#define MSG_WEBIRCEXTRA         "WEBIRCEXTRA"         /* WEBIRCEXTRA */
#define TOK_WEBIRCEXTRA         "WEBIRCEXTRA"
#define CMD_WEBIRCEXTRA         MSG_WEBIRCEXTRA, TOK_WEBIRCEXTRA
...
#define MSG_FINGERPRINT        "FINGERPRINT"    /* FINGERPRINT */
