/*
 * IRC - Internet Relay Chat, ircd/parse.c
...
struct Message msgtab[] = {
  ...
  },
  {
    ...
    0, MAXPARA, MFLG_SLOW, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { m_unregistered, m_alist, ms_alist, m_alist, m_ignore }
  },
  {
    MSG_NAMES,
    TOK_NAMES,
  ...
  },
  {
    ...
    0, MAXPARA, MFLG_SLOW, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { m_unregistered, m_not_oper, ms_set, mo_set, m_ignore }
  },
  {
    MSG_RESET,
    TOK_RESET,
  ...
  },
  {
    ...
    0, MAXPARA, MFLG_SLOW, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { m_ignore, mo_mkpasswd, m_ignore, mo_mkpasswd, m_ignore }
  },
  {
    MSG_ASLL,
    TOK_ASLL,
  ...
  },
  {
    ...
    0, MAXPARA, MFLG_SLOW, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { m_ignore, m_ignore, ms_smo, m_ignore, ms_smo }
  },
  {
    MSG_GLOBOPS,
    TOK_GLOBOPS,
    0, MAXPARA, MFLG_SLOW, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { m_ignore, m_not_oper, m_ignore, mo_globops, m_ignore }
  },
  {
    MSG_REMOVE,
    TOK_REMOVE,
...
parse_client(struct Client *cptr, char *buffer, char *bufend)
{
  ...
  {
    mptr = msg_tree_parse(MSG_PRIVATE, &msg_tree);
  }
  else if ((mptr = msg_tree_parse(ch, &msg_tree)) == NULL)
  {
    /*
...
int parse_server(struct Client *cptr, char *buffer, char *bufend)
{
  ...
  else
  {
    ...
    if (0 == i)
    {
      ...
      protocol_violation(cptr,"Missing Prefix [%s]", buffbackup ? buffbackup : "");
      from = cptr;
    }
    else if (' ' == ch[1] || ' ' == ch[2])
