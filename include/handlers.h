...
extern int m_webircextra(struct Client*, struct Client*, int, char*[]);
...
extern int mo_challenge(struct Client*, struct Client*, int, char*[]);
...
extern int mo_globops(struct Client*, struct Client*, int, char*[]);
extern int mo_exempt(struct Client*, struct Client*, int, char*[]);
...
extern int mo_spamfilter(struct Client*, struct Client*, int, char*[]);
...
extern int mo_uhelp(struct Client*, struct Client*, int, char*[]);
...
extern int ms_alist(struct Client*, struct Client*, int, char*[]);
...
extern int ms_challenge(struct Client*, struct Client*, int, char*[]);
...
extern int ms_exempt(struct Client*, struct Client*, int, char*[]);
...
extern int ms_ircops(struct Client*, struct Client*, int, char*[]);
...
extern int ms_spamfilter(struct Client*, struct Client*, int, char*[]);
