...
#define RPL_REDIR	      10	/* Hybrid: server redirect */
#define RPL_STATMEM           11        /* Undernet extension (pushed to 11 from 10)*/
...
#define RPL_WHOISVERIFIED    339	/* Nefarious extension */
