...
struct UserStatistics {
  ...
  unsigned int localclients;    /**< Local registered users. */
  unsigned int globalclients;   /**< Global registered users. */
  unsigned int conncount;       /**< Total connection count. */

  /* Global user mode changes: */
  unsigned int inv_clients;     /**< Invisible users ,*/
  unsigned int opers;           /**< Operators, */
  unsigned int authed;		/**< Authenticated users, */
